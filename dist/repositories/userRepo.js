...
var updateUser = function (id, body) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, findUserById(id)];
            case 1:
                user = (_a.sent());
...
exports.default = { saveUser: saveUser, findByEmailAndPassword: findByEmailAndPassword, findByIdAndDelete: findByIdAndDelete, findUserById: findUserById, updateUser: updateUser };
