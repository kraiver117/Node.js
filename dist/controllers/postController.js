...
var postRepo_1 = __importDefault(require("../repositories/postRepo"));
...
exports.postController.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, postRepo_1.default.createPost(req.body)];
            case 1:
                post = _a.sent();
                if (post) {
...
exports.postController.delete('/:id', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, postRepo_1.default.deletePost(id)];
            case 1:
                post = _a.sent();
                if (post) {
                    res.status(200).json({ message: 'Delete post:', post: post });
                }
                else {
                    res.status(400).json({ message: 'Not found', post: post });
                }
                return [2 /*return*/];
        }
    });
...
exports.postController.get('/:id', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, postRepo_1.default.findPostById(id)];
            case 1:
                post = _a.sent();
                if (post) {
...
exports.postController.post('/:id/comment', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, postRepo_1.default.commentPost(req.body)];
            case 1:
                comment = _a.sent();
                return [4 /*yield*/, postRepo_1.default.findPostById(id)];
            case 2:
                ...
                if (post) {
                    ...
                    post.save();
                    res.status(200).json({ post: post }).populate('author comments');
                }
                else {
...
exports.postController.patch('/:id', checkToken, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, postRepo_1.default.updatePost(id, req.body)];
            case 1:
                post = _a.sent();
                if (post) {
